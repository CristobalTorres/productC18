...
function setup() {
  ...
  //crear jugo de la fruta cortada
   blood=createSprite(50,200,20,20);
...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    //para que que el jugo este en la misma posicion del cuchillo
    blood.y=World.mouseY;
    blood.x=World.mouseX;
    //para que el objeto no se pueda ver
    blood.visible=false;
    ...
    if(fruitGroup.isTouching(knife)){
      ...
      //para que el objeto se pueda ver mientras se activa la condicional 
       blood.visible=true;
